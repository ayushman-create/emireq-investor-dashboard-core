    ...
    switch (step) {
      ...
      case 4:
        if (!formData.shariahCompliance)
          newErrors.shariahCompliance = "You must confirm Shariah compliance";
        break;
      case 5:
        if (
          !formData.primaryInvestmentGoals ||
          formData.primaryInvestmentGoals.length === 0
        ) {
          newErrors.primaryInvestmentGoals =
            "Please select at least one investment goal";
        }
        if (!formData.investmentTimeHorizon)
          newErrors.investmentTimeHorizon = "Please select a time horizon";
        break;
      case 6:
        if (
      ...
      case 2:
        return (
          <>
            ...
            <p className="register-form-subtitle">
              How can we reach you with important updates and opportunities?
            </p>
            ...
            <div className="register-form-group">
              ...
              <div className="register-input-wrapper">
                ...
                >
                  <path
                    d="M3.33334 5.83333L10 10.8333L16.6667 5.83333M3.33334 5C2.8731 5 2.5 5.3731 2.5 5.83333V14.1667C2.5 14.6269 2.8731 15 3.33334 15H16.6667C17.1269 15 17.5 14.6269 17.5 14.1667V5.83333C17.5 5.3731 17.1269 5 16.6667 5H3.33334Z"
                    stroke="#9CA3AF"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="register-investor-types">
              <label className="register-investor-type-card">
                ...
                <div className="register-investor-type-content">
                  <div className="register-investor-type-header">
                    <span className="register-investor-type-title">
                      Individual Investor
                    </span>
                    <svg
                  ...
                  <p className="register-investor-type-description">
              ...
              <label className="register-investor-type-card">
                ...
                <div className="register-investor-type-content">
                  ...
                  <p className="register-investor-type-description">
                    Large-scale institutional fund
                  </p>
                </div>
              </label>
            </div>
      ...
      case 4:
        return (
          <>
            ...
            <p className="register-form-subtitle">
              Confirm your commitment to Shariah-complaint investing
            </p>
            ...
            <div className="register-shariah-principles">
              <div className="register-shariah-header">
                ...
                <h3 className="register-shariah-title">
              ...
              <ul className="register-shariah-list">
                <li className="register-shariah-item">
                  <svg
                    className="register-shariah-check"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
                  ...
                  <span>
                    No involvement in prohibited activities (alcohol, gambling,
                    tobacco, etc.)
                  </span>
                </li>
                <li className="register-shariah-item">
                ...
                <li className="register-shariah-item">
                  ...
                  <span>
                    Asset-backed investments (avoiding excessive speculation)
                  </span>
                </li>
              </ul>
            </div>
              ...
              <label className="register-checkbox-label register-shariah-checkbox">
                ...
                <div className="register-shariah-checkbox-content">
                  <span className="register-checkbox-text">
                    I confirm that I want to invest only in Shariah-compliant
                    opportunities
                  </span>
                  <p className="register-shariah-helper">
                    By checking this box, you acknowledge that all your
                    investments through Emireq will be screened for Shariah
                    Compliance
                  </p>
                </div>
              </label>
            ...
            <div className="register-form-group">
              ...
              <div className="register-checkbox-group">
                <label className="register-checkbox-card">
                  <input
                    type="checkbox"
                    checked={formData.primaryInvestmentGoals.includes(
                      "long-term-wealth",
                    )}
                    onChange={() =>
                ...
                <label className="register-checkbox-card">
                  ...
                  />
                  <span className="register-checkbox-text">
                    Diversify with real estate and tokenized assets
                  </span>
                </label>
              ...
              <div className="register-radio-group">
                <label className="register-radio-card">
                  <input
                    ...
                    className="register-radio"
                  />
                  <span className="register-radio-text">
      ...
      case 6:
        return (
          <>
            ...
            <p className="register-form-subtitle">
              Which Investment stages interests you?
            </p>
              ...
              <div className="register-checkbox-group">
                <label className="register-checkbox-card">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxGroupChange("investmentStages", "pre-seed")
                    }
                    className="register-checkbox"
                  />
                ...
                <label className="register-checkbox-card">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxGroupChange("investmentStages", "seed")
                    }
                    className="register-checkbox"
                  />
                ...
                <label className="register-checkbox-card">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxGroupChange("investmentStages", "mvp")
                    }
                    className="register-checkbox"
                  />
                ...
                <label className="register-checkbox-card">
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxGroupChange("investmentStages", "other")
                    }
                    className="register-checkbox"
                  />
      ...
      case 7:
        return (
          <>
            ...
            <p className="register-form-subtitle">
              Select at least 3 sectors you're interested in investing
            </p>
            ...
            <div className="register-form-group">
              ...
              <div className="register-checkbox-group">
                <label className="register-checkbox-card">
                  <input
                    type="checkbox"
                    checked={formData.sectorInterests.includes(
                      "technology-software",
                    )}
                    onChange={() =>
                      handleCheckboxGroupChange(
                  ...
                  />
                  <svg
                    className="register-sector-icon"
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
                    fill="none"
                ...
                <label className="register-checkbox-card">
                  ...
                  >
                    <path
                      d="M20.84 4.61C19.5 3.28 17.66 2.5 15.54 2.5C13.43 2.5 11.59 3.28 10.25 4.61L12 6.37L13.75 4.61C14.66 3.71 15.92 3.2 17.29 3.2C18.66 3.2 19.92 3.71 20.83 4.61C22.73 6.51 22.73 9.64 20.83 11.54L12 20.37L3.17 11.54C1.27 9.64 1.27 6.51 3.17 4.61C4.08 3.71 5.34 3.2 6.71 3.2C8.08 3.2 9.34 3.71 10.25 4.61L12 6.37L10.25 8.12"
                      stroke="#374151"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <label className="register-checkbox-card">
                  ...
                  >
                    <path
                      d="M3 21H21M3 7L12 3L21 7M4 7V21M20 7V21M8 10V17M12 10V17M16 10V17"
                      stroke="#374151"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <label className="register-checkbox-card">
                  ...
                  >
                    <path
                      d="M5 11L7 7H17L19 11M5 11V17C5 17.55 5.45 18 6 18H7C7.55 18 8 17.55 8 17V16H16V17C16 17.55 16.45 18 17 18H18C18.55 18 19 17.55 19 17V11M5 11H19M7.5 14H7.51M16.5 14H16.51"
                      stroke="#374151"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
      ...
      case 8:
        return (
          <>
            ...
            <p className="register-form-subtitle">
              Upload required documents to verify your identity and investor
              status
            </p>
            ...
            <div className="register-form-group">
              ...
              <p className="register-upload-helper">
              ...
              {formData.governmentId ? (
                <div className="register-upload-success">
                  <div className="register-upload-success-content">
                    <svg
                      className="register-upload-success-icon"
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                      fill="none"
                    ...
                    <div className="register-upload-success-info">
                      <span className="register-upload-success-filename">
                        {formData.governmentId.name}
                      </span>
                      <span className="register-upload-success-status">
                ...
                <label className="register-upload-box">
                  <input
                    ...
                    onChange={(e) =>
                      handleFileChange("governmentId", e.target.files[0])
                    }
                    className="register-upload-input"
                  />
                  <div className="register-upload-content">
                    <svg
                      className="register-upload-icon"
                      width="40"
                      height="40"
                      viewBox="0 0 40 40"
                      fill="none"
                    ...
                    <span className="register-upload-hint">
              ...
              {formData.accreditationDoc ? (
                ...
                <label className="register-upload-box">
                  <input
                    ...
                    accept=".pdf,.jpg,.jpeg,.png"
                    onChange={(e) =>
                      handleFileChange("accreditationDoc", e.target.files[0])
                    }
                    className="register-upload-input"
                  />
                  <div className="register-upload-content">
              ...
              {formData.proofOfFunds ? (
                ...
                <label className="register-upload-box">
                  <input
                    ...
                    accept=".pdf,.jpg,.jpeg,.png"
                    onChange={(e) =>
                      handleFileChange("proofOfFunds", e.target.files[0])
                    }
                    className="register-upload-input"
                  />
                  <div className="register-upload-content">
          ...
          <div className="register-left-content">
            ...
            <div className="register-left-info">
              ...
              {currentStep === 1 && (
                <>
                  ...
                  <p className="register-left-description">
                    We'd love to get to know you better. This information helps
                    us personalize your investment experience.
                  </p>
                </>
              )}
              ...
              {(currentStep === 2 || currentStep === 3) && (
                <>
                  <h1 className="register-left-heading">
                    We'll keep you updated on deals that match your investment
                    profile.
                  </h1>
              ...
              {currentStep === 4 && (
                <>
                  ...
                  <p className="register-left-description">
                    Emireq is commited to providing only Shariah-compliant
                    investment opportunities. All our investments are screened
                    and certified by qualified Shariah Scholars.
                  </p>
                </>
              )}
              ...
              {currentStep === 7 && (
                <>
                  ...
                  <p className="register-left-description">
                    By understanding your sector preferences, we can curate
                    investment opportunities that align with your interests and
                    expertise.
                  </p>
                  <div className="register-left-features">
                    <div className="register-feature-item">
              ...
              {currentStep === 8 && (
                <>
                  ...
                  <p className="register-left-description">
                    To comply with regulations and protect all parties, we need
                    to verify your identity and investment qualifications.
                  </p>
                  <div className="register-security-box">
                    <p className="register-security-title">
                      Your documents are:
                    </p>
