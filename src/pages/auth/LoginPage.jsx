...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    const response = await loginInvestor(INVESTROR_LOGIN_ENDPOINT, payload);
    if (!response.ok) {
      ...
      <div className="login-left">
        ...
        <div className="login-form-container">
          <h1 className="login-title">
            {isLoginError ? "Sign in to your account" : "Welcome"}
          </h1>
            ...
            <div className="login-form-group">
              ...
              {usernameError && (
                <span className="login-error">
                  ...
                  >
                    <path
                      d="M8 5.33331V7.99998M8 10.6666H8.00667M14.6667 7.99998C14.6667 11.6819 11.6819 14.6666 8 14.6666C4.3181 14.6666 1.33333 11.6819 1.33333 7.99998C1.33333 4.31808 4.3181 1.33331 8 1.33331C11.6819 1.33331 14.6667 4.31808 14.6667 7.99998Z"
                      stroke="currentColor"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
          ...
          <div className="login-social-buttons">
            <button type="button" className="login-social-btn">
              ...
              >
                ...
                />
                <path
                  d="M12 5.38C13.62 5.38 15.06 5.91 16.21 7.02L19.36 3.87C17.45 2.09 14.97 1 12 1C7.7 1 3.99 3.47 2.18 7.07L5.84 9.91C6.71 7.31 9.13 5.38 12 5.38Z"
                  fill="#EA4335"
                />
              </svg>
            </button>
        ...
        >
          <div className="login-right-content">
            ...
            <div className="login-support-text">
              ...
              <br />
              Get assistance via{" "}
              <a href="mailto:support@emireq.com">support@emireq.com</a>
            </div>
          </div>
        </div>
      </div>
        ...
        >
          <div className="login-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="login-modal-icon">
              ...
              >
                <path
                  d="M36.3347 16.6671C37.0958 20.4026 36.5534 24.2862 34.7978 27.6701C33.0421 31.0541 30.1795 33.7339 26.6872 35.2627C23.1949 36.7914 19.2841 37.0768 15.6068 36.0711C11.9296 35.0654 8.70833 32.8295 6.48014 29.7362C4.25195 26.6429 3.15155 22.8792 3.36245 19.0728C3.57335 15.2664 5.08281 11.6473 7.6391 8.81909C10.1954 5.99089 13.644 4.12452 17.4098 3.53123C21.1756 2.93793 25.031 3.65357 28.333 5.5588"
                  stroke="#00A63E"
                  strokeWidth="3.33333"
                  strokeLinecap="round"
                  strokeLinejoin="round"
