...
export default function Header({ isDarkMode, toggleTheme }) {
  ...
  const isDueDiligencePage = location.pathname === "/diligence";
    ...
    <header className="em-header">
      {isPortfolioPage ? (
        <div className="em-header-breadcrumb">
          ...
          <span className="em-breadcrumb-item em-breadcrumb-item--active">Portfolio</span>
        </div>
      ) : isTokenPage ? (
        <div className="em-header-breadcrumb">
          <span className="em-breadcrumb-item">Dashboard</span>
        ...
        <div className="em-header-breadcrumb">
          ...
          <span className="em-breadcrumb-item em-breadcrumb-item--active">Documents</span>
        </div>
      ) : isDueDiligencePage ? (
        <div className="em-header-breadcrumb">
          <span className="em-breadcrumb-item">Dashboard</span>
          ...
          <span className="em-breadcrumb-item em-breadcrumb-item--active">Due Diligence</span>
        </div>
      ) : (
